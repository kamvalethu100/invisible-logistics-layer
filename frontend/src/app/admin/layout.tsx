...
import { Activity, ShieldAlert, BarChart3, LogOut, User, LayoutDashboard, Target, Users2, Map as MapIcon, Landmark } from 'lucide-react';
...
const navItems = [
  ...
  { icon: Landmark, label: 'Payment Settlement', href: '/admin/payments' },
...
export default function AdminLayout({
  ...
  // For the pilot, we allow admins but also maybe check if the user is an admin.
  // Assuming 'admin' role exists in the backend as per useAuth interface.
      ...
      <div className="flex min-h-screen bg-slate-50">
        ...
        <div className="flex-1 flex flex-col min-w-0 h-screen">
          <header className="md:hidden bg-slate-900 text-white p-4 flex justify-between items-center">
            <h1 className="text-lg font-bold tracking-tight">FlowGrid Ops</h1>
